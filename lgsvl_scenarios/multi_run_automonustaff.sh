...
# python3 autonomustaff-01-static-bypass.py 1 e p
# sleep 1

# python3 autonomustaff-02-static-roadblock.py 1 e p
# sleep 1

# python3 autonomustaff-03-dynamic_pedestr_90.py 1 s
# sleep 1

# python3 autonomustaff-04-dynamic_pedestr_45.py 1 s
# sleep 1

# python3 autonomustaff-05-dynamic-vehicles-on-front.py 1 e p s
# sleep 1

# python3 autonomustaff-06-pedestrian-cross-loop.py 1 e p s
# sleep 1

python3 autonomustaff-07-car-cross.py 2 e p t s
sleep 1
