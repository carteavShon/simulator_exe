...
scenario_num = 3
scenario_name = "Dynamic pedestrian on front in 90 degrees"
...
for loop_index in range(params.loop_count):
    ...
    ped = sim.add_agent( random.choice(simulator_types.pedestrian_types), lgsvl.AgentType.PEDESTRIAN, 
        lgsvl.AgentState(transform = Transform(position = start, rotation = simulator_types.positions.ped_rotation_90_ganheb)))
