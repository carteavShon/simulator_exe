...
scenario_num = 11
scenario_name = "Head pedestrian collision at “Letters”"
...
for loop_index in range(params.loop_count):
    ...
    # print(vehicle.name + ' Python-Api compatible sensors:')
    ...
    start_ped = simulator_types.lat_lon_2_map_ground(sim, 31.96440, 34.826281)
    end_ped = simulator_types.lat_lon_2_map_ground(sim, 31.96412, 34.826100)
